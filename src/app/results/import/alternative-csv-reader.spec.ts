...
import { TimeUtilities, WrongFileFormat } from "../model";
...
describe("Input.AlternativeCSV.TripleColumn", () => {
  ...
  it("Cannot parse an empty string", () => {
    expect(() => parseTripleColumnEventData(""), "Should throw an exception for parsing an empty string").toThrowError(WrongFileFormat);
  });
