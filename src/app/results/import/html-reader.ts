...
*/
function hasNumber(string): boolean {
    string = string.trim();
...
*     tags.
*/
OEventTabularHtmlFormatRecognizer.prototype.isTextOfThisFormat = function (text: string) {
...
* @sb-return {String} The preprocessed text.
*/
OEventTabularHtmlFormatRecognizer.prototype.preprocess = function (text: string): string {
...
* @sb-return {boolean} True if the line should be ignored, false if not.
*/
OEventTabularHtmlFormatRecognizer.prototype.canIgnoreThisLine = function (line: string): boolean {
...
*     otherwise.
*/
OEventTabularHtmlFormatRecognizer.prototype.isCourseHeaderLine = function (line: string) {
