...
import { ChartConfiguration, ChartData, ChartEvent, TooltipItem, TooltipModel } from 'chart.js';
      ...
      plugins: {
         ...
         tooltip: {
            callbacks: {
               ...
               title: (context: TooltipItem<"bar">[]) => (context[0].label === 'F') ?
                  'Finish' :
                  'Control ' + context[0].label,
            },
