...
(function (){
    ...
    */
    CourseClass.prototype.getFastestSplitTo = function (controlIdx) {
        ...
        // @ts-ignore  fastestCompetitor must be ste of fastest splt was found
    ...
    Reader.prototype.identifyFormatVariation = function (delimiter) {
        ...
        for (var columnOffset in COLUMN_INDEXES) {
            if (COLUMN_INDEXES.hasOwnProperty(columnOffset)) {
                ...
                var col= parseInt(columnOffset, 10);
                var colMinus2 = (col- 2).toString();
                var colMinus1 = (col- 1).toString();
                ...
                if (columnOffset < firstLine.length &&
                        ...
                        (firstLine[colMinus2].trim() === "" || parseTime(firstLine[colMinus2]) !== null) &&
                        (firstLine[colMinus1].trim() === "" || parseTime(firstLine[colMinus1]) !== null)) {
