...
import { CourseClass, FastestSplitInfo, FastestTimeInfo } from "./course-class.js";
...
export class Course {
   ...
   */
   ...
   /**
   * Returns the number of splits on the course.
   * @sb-return {Number} Number of course-classes that use this course.
   */
   public get numSplits(): number {
      if (this._numSplits === -1) {
         let numSplits = -1;
