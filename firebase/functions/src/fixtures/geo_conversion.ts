...
GT_OSGB.prototype.setGridCoordinates = function ( eastings: number, northings: number ) {
   this.northings = northings;
   this.eastings = eastings;
   this.status = "OK";
};

GT_OSGB.prototype.setError = function ( msg: GT_status ) {
   this.status = msg;
};

GT_OSGB.prototype._zeropad = function ( num: number, len: number ) {
...
GT_OSGB.prototype.getGridRef = function ( precision: number ) {
...
GT_Irish.prototype.setGridCoordinates = function ( eastings: number, northings: number ) {
   this.northings = northings;
   this.eastings = eastings;
   this.status = "OK";
};

GT_Irish.prototype.setError = function ( msg: GT_status ) {
   this.status = msg;
};

GT_Irish.prototype._zeropad = function ( num: number, len: number ) {
   let str = num.toString();
   while ( str.length < len ) {
      str = '0' + str;
   }
...
GT_Irish.prototype.getGridRef = function ( precision: number ) {
...
GT_Irish.prototype.getWGS84 = function ( uselevel2: boolean ) {
...
GT_WGS84.prototype.parseString = function ( text: string ) {
   let ok = false;
...
GT_WGS84.prototype.isGreatBritain = function (): boolean {
...
GT_WGS84.prototype.isIreland = function (): boolean {
...
GT_WGS84.prototype.isIreland2 = function (): boolean {
...
GT_WGS84.prototype.getIrish = function ( uselevel2: boolean ) {
...
GT_WGS84.prototype.getOSGB = function ( uselevel2: boolean ) {
...
GT_Math.E_N_to_Lat = function ( East: number, North: number, a: number,
   b: number, e0: number, n0: number, f0: number, PHI0: number, LAM0: number ) {
...
GT_Math.E_N_to_Long = function ( East: number, North: number, a: number, b: number,
   e0: number, n0: number, f0: number, PHI0: number, LAM0: number ) {
...
GT_Math.InitialLat = function ( North: number, n0: number, afo: number, PHI0: number, n: number, bfo: number ) {
   // Compute initial value for Latitude (PHI) IN RADIANS.
   // Input: - _
...
GT_Math.Helmert_Z = function ( X: number, Y: number, Z: number, DZ: number, X_Rot: number, Y_Rot: number, s: number ) {
...
GT_Math.XYZ_to_Lat = function ( X: number, Y: number, Z: number, a: number, b: number ) {
...
GT_Math.Iterate_XYZ_to_Lat = function ( a: number, e2: number, PHI1: number, Z: number, RootXYSqr: number ) {
...
GT_Math.XYZ_to_Long = function ( X: number, Y: number ) {
...
GT_Math.Lat_Long_to_East = function ( PHI: number, LAM: number, a: number, b: number, e0: number, f0: number, PHI0: number, LAM0: number ) {
...
GT_Math.Lat_Long_to_North = function ( PHI: number, LAM: number, a: number, b: number,
   e0: number, n0: number, f0: number, PHI0: number, LAM0: number ) {
